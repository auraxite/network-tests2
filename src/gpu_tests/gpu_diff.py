...
На вход подаются два .txt лога одного формата (как у gpu_render.py).
...
дописана в заголовок, как в gpu_render.
...
# Переиспользуем разбор и общие утилиты у gpu_render — он лежит рядом.
import gpu_render as gr
...
def draw_diff_heatmap(
	...
	*,
	...
	таблицей-сеткой (как и у gpu_render).
	"""
	axis_fs = 9
